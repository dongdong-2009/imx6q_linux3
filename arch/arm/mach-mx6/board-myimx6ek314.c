...
#include "board-myimx6ek314-6q.h"
#include "board-myimx6ek314-6u.h"

#define SABRESD_VOLUME_UP	IMX_GPIO_NR(6, 15)
#define SABRESD_VOLUME_DN	IMX_GPIO_NR(6, 10)
...
#define SABRESD_PCIE_WAKE_B	IMX_GPIO_NR(7, 11)
...
#define SABRESD_HEADPHONE_DET	IMX_GPIO_NR(1, 5)
//#define SABRESD_HEADPHONE_DET	IMX_GPIO_NR(7, 0)
//#define SABRESD_HEADPHONE_DET	IMX_GPIO_NR(3, 20)
#define SABRESD_PCIE_RST_B_REVB	IMX_GPIO_NR(6, 14)
...
#define SABRESD_FT5X06_INT	IMX_GPIO_NR(6, 7)
#define SABRESD_FT5X06_RST	IMX_GPIO_NR(2, 1)

//#define SABRESD_USER_LED 	IMX_GPIO_NR(3, 20)
#define SABRESD_USER_LED	IMX_GPIO_NR(3, 22)
...
static void mxc_rs485_dir_set(int value)
{
	if (value)
	gpio_set_value(SABRESD_RS485_DIR, 1);
	else
	gpio_set_value(SABRESD_RS485_DIR, 0);	
}
...
static int mx6q_sabresd_fec_phy_init(struct phy_device *dev)
{
